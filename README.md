...
## 🔐 موبایل و بازیابی رمز

راهنمای تنظیم پنل پیامک، حساب‌های قدیمی، تست‌ها و انتشار در [docs/auth-sms.md](docs/auth-sms.md) آمده است. ثبت‌نام جدید تنها پس از تأیید پیامکی موبایل کامل می‌شود.
