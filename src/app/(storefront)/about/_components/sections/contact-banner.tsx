...
export function ContactBanner() {
  return (
    <section
      className="relative container mx-auto max-w-5xl overflow-hidden rounded-[28px] p-8 sm:px-5 lg:px-7 bg-navy text-cream"
    >
      ...
      <Link
        href="/contact"
        className="mt-5 inline-flex rounded-full px-6 py-3 font-black bg-gold text-navy-deep"
      >
        تماس و آدرس کامل
      </Link>
    </section>
