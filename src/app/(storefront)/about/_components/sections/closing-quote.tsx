...
export function ClosingQuote() {
  ...
  return (
    <section className="container mx-auto mb-14 max-w-5xl px-3 sm:px-5 lg:px-7">
      <div
        className="relative overflow-hidden rounded-[28px] border px-6 py-10 text-center sm:px-12 sm:py-14 border-gold/30 bg-white/90 shadow-[0_18px_40px_-28px_rgba(14,42,71,.28)] dark:border-gold/35 dark:bg-slate/50"
      >
        <span
          className="animate-orn-spin pointer-events-none absolute inset-e-[8%] top-[18%] hidden opacity-7 select-none sm:block text-gold"
          aria-hidden
        >
