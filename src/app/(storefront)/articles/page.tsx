...
export const metadata = buildMetadata({
  title: "مجله ملی‌کیدز",
  description: "راهنمای سایز، مراقبت از پارچه، استایل‌های فصلی و نکته‌های خرید پوشاک کودک در مجله ملی‌کیدز.",
  path: "/articles",
  type: "article",
...
export default function ArticlesPage() {
  ...
  return (
    <>
      <Intro crumb="مجله" kicker="JOURNAL" title="مجله ملی‌کیدز" lead="راهنماهای کوتاه و کاربردی برای انتخاب سایز، نگهداری پارچه و ساختن استایل‌های کودکانه." />
