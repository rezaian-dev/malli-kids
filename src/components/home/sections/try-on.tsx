      ...
      <div className="container mx-auto w-full px-4 sm:px-5 lg:px-7">
        <div className="bg-navy shadow-navy/30 relative overflow-hidden rounded-3xl bg-[radial-gradient(rgba(255,255,255,.09)_1px,transparent_1px)] bg-size-[22px_22px] shadow-2xl transition-all duration-700 ease-out sm:rounded-[36px]">
          ...
          <div className="relative grid items-center gap-10 p-6 min-[420px]:p-8 sm:p-12 lg:grid-cols-2 lg:gap-8 lg:p-16">
            <div>
              <div className="border-gold/30 bg-gold/15 mb-5 inline-flex items-center gap-2 rounded-full border px-3.5 py-1.5 sm:mb-6 sm:px-4 sm:py-2">
              ...
              <div className="mt-7 space-y-4 sm:mt-8 sm:space-y-5">
                {STEPS.map(({ Icon, t, d }) => (
                  <div key={t} className="flex items-start gap-3 sm:gap-4">
                    <span className="border-gold/25 bg-gold/15 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border sm:h-11 sm:w-11 sm:rounded-2xl">
              ...
              <div className="mt-8 flex flex-col flex-wrap gap-3 min-[420px]:flex-row sm:mt-10 sm:gap-4">
                <Link
                  href="/tryon"
                  className="bg-gold text-navy-deep shadow-gold/25 hover:bg-gold-light relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full px-7 py-3.5 text-sm font-black shadow-lg transition-all duration-500 hover:-translate-y-1 sm:px-8 sm:py-4 sm:text-base"
                >
                ...
                <Link
                  href="/tryon"
                  className="border-cream/30 text-cream relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full border px-6 py-3.5 text-sm font-bold transition-all duration-500 hover:-translate-y-1 hover:bg-white/10 sm:px-7 sm:py-4 sm:text-base"
                >
                  ورود به اتاق پرو
                </Link>
              </div>
            ...
            <div className="relative mt-2 lg:mt-0">
              <div className="relative overflow-hidden rounded-2xl border border-white/15 shadow-2xl sm:rounded-[28px]">
                ...
                <div className="absolute inset-x-4 bottom-4 flex items-center justify-between gap-2 sm:inset-x-5 sm:bottom-5">
                  <div className="bg-navy-deep min-w-0 rounded-xl border border-white/10 px-3 py-2 sm:rounded-2xl sm:px-4 sm:py-3">
                  ...
                  <span className="bg-gold shadow-gold/40 flex h-10 w-10 shrink-0 items-center justify-center rounded-full shadow-lg sm:h-12 sm:w-12">
