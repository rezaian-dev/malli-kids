    ...
    >
      ...
      <div className="container mx-auto grid w-full items-center gap-16 px-4 sm:gap-14 sm:px-5 lg:grid-cols-2 lg:gap-10 lg:px-7">
        <div className="relative order-2 h-90 transition-all duration-700 ease-out min-[420px]:h-105 sm:h-135 lg:order-1">
          ...
          >
            <Image
              ...
              width={768}
              height={1152}
              sizes="(max-width: 1023px) 78vw, 39vw"
        ...
        <div className="order-1 transition-all duration-700 ease-out lg:order-2">
          ...
          <p className="text-navy/70 dark:text-wheat mt-4 text-sm leading-7 sm:mt-5 sm:text-base sm:leading-8">
          ...
          <div className="mt-8 grid grid-cols-1 gap-3.5 min-[480px]:grid-cols-2 sm:mt-9 sm:gap-4">
            {CARDS.map((card) => (
              <Link
                ...
                prefetch={false}
                className={cn(
                  "group relative rounded-2xl border p-5 transition-all hover:-translate-y-1 hover:shadow-xl sm:rounded-3xl sm:p-6",
                  "border-navy/5 hover:border-gold/50 hover:shadow-gold/10 bg-white/92",
                  card.shift && "min-[480px]:translate-y-5",
                  "dark:border-gold/25 dark:bg-slate/55",
                )}
              >
                <span
                  className={cn(
                ...
                <p className="text-navy/70 dark:text-wheat mt-1.5 text-xs leading-6 sm:mt-2 sm:text-sm">
                  {card.d}
                </p>
              </Link>
            ))}
