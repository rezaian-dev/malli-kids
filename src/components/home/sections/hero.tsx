    ...
    >
      ...
      <div className="relative container mx-auto grid w-full items-center gap-12 px-4 sm:px-5 lg:grid-cols-2 lg:gap-8 lg:px-7">
        <div className="relative z-10 text-center lg:text-right">
          <div className="animate-hero-in border-gold text-navy dark:bg-linen dark:text-navy mb-6 inline-flex items-center gap-2 rounded-full border-[1.5px] bg-white px-3.5 py-1.5 shadow-[0_8px_24px_-12px_rgba(193,147,87,.7)] transition-transform delay-75 duration-500 hover:-translate-y-0.5 sm:mb-7 sm:px-4 sm:py-2">
            <Sparkles className="h-4 w-4 shrink-0" />
            <span className="text-xs font-semibold sm:text-sm">
              کالکشن جدید پاییز – زمستان ۱۴۰۴
            </span>
          </div>
          <h1 className="animate-hero-in text-navy dark:text-linen text-[clamp(1.75rem,7vw,4rem)] leading-[1.3] font-black delay-150">
            دنیای شیکِ
          ...
          <p className="animate-hero-in text-navy/60 dark:text-khaki mx-auto mt-6 max-w-xl text-[15px] leading-7 delay-300 sm:mt-7 sm:text-lg sm:leading-8 lg:mx-0">
          ...
          <div className="animate-hero-in mt-8 flex flex-col flex-wrap items-stretch justify-center gap-3 delay-500 min-[420px]:flex-row min-[420px]:items-center sm:mt-9 sm:gap-4 lg:justify-start">
            <Link
              href="/#styles"
              className="group from-navy via-navy-mid to-navy text-cream ring-gold/40 hover:ring-gold relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-linear-to-l px-8 py-3.5 text-sm font-black shadow-[0_12px_28px_-8px_rgba(14,42,71,.45)] ring-2 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.05] hover:shadow-[0_18px_40px_-10px_rgba(193,147,87,.6)] sm:px-9 sm:py-4 sm:text-base"
            >
              <span
            ...
            <Link
              href="/tryon"
              className="group border-gold bg-gold text-navy-deep hover:bg-gold-light relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full border-2 px-8 py-3 text-sm font-black shadow-[0_0_28px_rgba(193,147,87,.45)] transition-all duration-500 hover:-translate-y-2 hover:scale-[1.05] hover:shadow-[0_18px_40px_-10px_rgba(193,147,87,.7)] sm:px-9 sm:py-3.75 sm:text-base"
            >
              <span
          ...
          <div className="mx-auto mt-10 grid max-w-md grid-cols-3 gap-2 min-[420px]:gap-6 sm:mt-12 sm:gap-10 lg:mx-0 lg:flex lg:max-w-none lg:items-center lg:justify-start">
            <div className="animate-hero-in min-w-0 text-center delay-200 lg:text-right">
              <div className="text-navy dark:text-ivory text-base font-black min-[380px]:text-xl sm:text-3xl">
                +۱۲٬۰۰۰
              </div>
              <div className="text-navy/50 dark:text-wheat mt-1 text-[10px] leading-4 min-[380px]:text-xs sm:text-sm">
                مادر خوشحال
              </div>
            </div>
            ...
            <div className="animate-hero-in min-w-0 text-center lg:text-right">
              <div className="text-navy dark:text-ivory flex items-center justify-center gap-1 text-base font-black min-[380px]:text-xl sm:text-3xl lg:justify-start">
                ۴٫۹
        ...
        <div className="group/hero animate-hero-in xs:max-w-[20rem] xs:px-4 relative mx-auto w-full max-w-[18rem] px-2 delay-200 sm:max-w-110 sm:px-0">
          ...
          <div className="animate-orn-sway border-gold/50 absolute -inset-3 -z-10 rounded-t-[999px] rounded-b-[40px] border-2 border-dashed sm:-inset-5 sm:rounded-b-[48px]" />
          <div className="animate-floaty shadow-navy/15 absolute top-14 -right-1 flex max-w-50 items-center gap-2 rounded-xl bg-white p-2.5 shadow-xl min-[420px]:-right-4 sm:top-16 sm:-right-10 sm:max-w-57.5 sm:gap-3 sm:rounded-2xl sm:p-3.5">
            <span className="bg-gold/15 text-gold flex h-10 w-10 shrink-0 items-center justify-center rounded-xl sm:h-12 sm:w-12">
            ...
            <div className="min-w-0 text-right">
              ...
              <p className="text-navy/50 mt-0.5 text-[10px] leading-4 sm:text-[11px]">
