  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "focus-visible:ring-gold/40 focus-visible:ring-3",

        "border-navy/15 bg-navy/10 dark:border-white/15 dark:bg-white/10",

        "data-[state=checked]:border-gold-deep/60",
        "data-[state=checked]:from-gold-deep data-[state=checked]:via-gold data-[state=checked]:to-gold-light data-[state=checked]:bg-linear-to-l",
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "ring-gold-deep/25 pointer-events-none block translate-x-0 rounded-full bg-white shadow-[0_1px_4px_rgba(14,42,71,.45)] ring-1 transition-transform duration-200",
