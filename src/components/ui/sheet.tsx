...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-80",
        "bg-navy-deep/45 backdrop-blur-[2px] duration-200 ease-out",
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "bg-popover text-popover-foreground bg-clip-padding text-sm shadow-lg transition duration-200 ease-out data-[side=bottom]:border-t data-[side=left]:border-e data-[side=right]:border-s data-[side=top]:border-b",
