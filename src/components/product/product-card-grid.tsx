  ...
  return (
    ...
    >
      <div className="bg-sand relative w-full shrink-0 overflow-hidden pt-[125%]">
        ...
        <FavButton id={p.id} name={p.name} className="absolute inset-s-2.5 top-2.5" />
        {out ? (
      ...
      <div className="flex flex-1 flex-col px-3 pt-3 pb-3.5">
        ...
        <div className="mt-auto grid grid-cols-1 gap-1.5 pt-2.5 pointer-fine:min-[520px]:hidden">
          <Link href={href} prefetch={false} className={cn(VIEW, "h-9 min-w-0 whitespace-nowrap text-[11px]")}>
          ...
          <AddToCartButton
            ...
            className={cn(
              ...
              "h-9 min-w-0 whitespace-nowrap rounded-[10px] border-0 text-[11px] font-black",
            )}
          >
