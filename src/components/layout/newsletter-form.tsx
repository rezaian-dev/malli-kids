    ...
    >
      ...
      >
        <input
          ...
          className="newsletter-field field-autofill scheme-light caret-cream text-cream placeholder:text-taupe h-10 min-w-0 flex-1 rounded-full bg-transparent px-4 text-right text-sm shadow-none outline-none"
        />
        <button
          type="submit"
