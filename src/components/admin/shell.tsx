...
import { LogOut, Menu, Moon, Shirt, Sun, X } from "lucide-react";
          ...
          <div className="flex items-center gap-2 px-3 py-3 sm:px-5">
            ...
            <div className="ms-auto flex min-w-0 items-center gap-2">
              <Button
                ...
                variant="outline"
                size="icon"
                className="size-10 rounded-full border-navy/10 bg-white text-navy dark:border-gold/25 dark:bg-navy-mid dark:text-gold-soft"
                onClick={toggleTheme}
