...
export function AdminTable<T extends { id: string | number }>({
  ...
  return (
    <section
      className={cn(
        "overflow-hidden rounded-[22px] max-[639px]:rounded-[19px]",
        "border-navy/13 bg-paper/94 border shadow-[0_24px_55px_-38px_rgba(14,42,71,0.46),inset_0_1px_0_rgba(255,255,255,0.8)] backdrop-blur-[18px]",
        "dark:border-gold-soft/24 dark:bg-[rgba(16,43,70,0.72)] dark:shadow-[0_28px_65px_-38px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.055),0_0_35px_rgba(193,147,87,0.025)]",
        className,
      )}
    >
      {header ? (
      ...
      {rows.length > 0 ? (
        <>
                ...
                <div className={HEAD_ROW} style={gridStyle} role="row">
                  {cols.map((column) => (
                    <div
                      ...
                      role="columnheader"
                      className={cn(
                        "min-w-0 px-3.5 py-3 text-[10px] font-black tracking-wide whitespace-nowrap",
                        "not-last:border-e not-last:border-[rgba(255,248,236,0.105)]",
                        "dark:not-last:border-[rgba(232,197,122,0.12)]",
                ...
                <div className="" role="rowgroup">
                  {rows.map((row) => (
                    <div
                      ...
                      className={cn(
                        "relative grid min-h-15 items-stretch border-b bg-white/34 transition-[background-color,box-shadow] duration-220 ease-[cubic-bezier(.25,.1,.25,1)] last:border-b-0",
                        "even:bg-navy/[0.022] hover:bg-gold/9 focus-visible:bg-gold/9 border-[rgba(14,42,71,0.095)] hover:z-10 hover:shadow-[inset_3px_0_0_var(--color-gold),inset_-3px_0_0_rgba(193,147,87,0.32),0_8px_24px_-20px_rgba(14,42,71,0.5)] focus-visible:z-10 focus-visible:shadow-[inset_3px_0_0_var(--color-gold),inset_-3px_0_0_rgba(193,147,87,0.32),0_8px_24px_-20px_rgba(14,42,71,0.5)]",
                        "dark:even:bg-gold-soft/[0.024] dark:hover:bg-gold-soft/[0.07] dark:focus-visible:bg-gold-soft/[0.07] dark:border-[rgba(232,197,122,0.125)] dark:bg-[rgba(4,20,39,0.17)]",
          ...
          <div
            ...
            aria-label="جدول اطلاعات"
          >
            <div className={HEAD_ROW} style={tabletGridStyle} role="row">
              {tabletCols.map((column) => (
                <div
                  key={column.key}
                  role="columnheader"
                  className={cn(
                    "min-w-0 px-3 py-3 text-[9px] font-black whitespace-nowrap",
                    "not-last:border-e not-last:border-[rgba(255,248,236,0.105)]",
                    "dark:not-last:border-[rgba(232,197,122,0.12)]",
                    ALIGN[column.align ?? "start"],
                  )}
            ...
            <div className="" role="rowgroup">
              {rows.map((row) => (
                <div
                  ...
                  onKeyDown={(event) => onKeyDown(event, row)}
                  className={cn(
                    "relative grid min-h-14.5 items-stretch border-b bg-white/34 transition-[background-color,box-shadow] duration-220 ease-[cubic-bezier(.25,.1,.25,1)] last:border-b-0",
                    "even:bg-navy/[0.022] hover:bg-gold/9 focus-visible:bg-gold/9 border-[rgba(14,42,71,0.095)] hover:z-10 hover:shadow-[inset_3px_0_0_var(--color-gold),inset_-3px_0_0_rgba(193,147,87,0.32),0_8px_24px_-20px_rgba(14,42,71,0.5)] focus-visible:z-10 focus-visible:shadow-[inset_3px_0_0_var(--color-gold),inset_-3px_0_0_rgba(193,147,87,0.32),0_8px_24px_-20px_rgba(14,42,71,0.5)]",
                    "dark:even:bg-gold-soft/[0.024] dark:hover:bg-gold-soft/[0.07] dark:focus-visible:bg-gold-soft/[0.07] dark:border-[rgba(232,197,122,0.125)] dark:bg-[rgba(4,20,39,0.17)]",
                    onRowClick && "cursor-pointer",
                  )}
                >
                  {tabletCols.map((column) => (
                    <div
                      ...
                      role="cell"
                      className={cn(
                        "flex min-w-0 flex-col justify-center px-3 py-2 text-[11px] leading-5 font-bold not-last:border-e not-last:border-[rgba(14,42,71,0.075)]",
                        "text-navy",
                        "dark:text-ivory dark:not-last:border-[rgba(232,197,122,0.105)]",
                        ALIGN[column.align ?? "start"],
                      )}
          ...
          >
            {rows.map((row) => (
              <article
                ...
                onKeyDown={(event) => onKeyDown(event, row)}
                className={cn(
                  "overflow-hidden rounded-[14px] transition-[transform,border-color,box-shadow] duration-220 ease-[cubic-bezier(.25,.1,.25,1)]",
                  "border border-[rgba(14,42,71,0.14)] bg-[rgba(255,255,255,0.86)] shadow-[0_10px_24px_-22px_rgba(14,42,71,0.52),inset_0_1px_0_rgba(255,255,255,0.85)] hover:-translate-y-0.5 hover:border-[rgba(193,147,87,0.48)] hover:shadow-[0_22px_42px_-28px_rgba(14,42,71,0.56)] focus-visible:-translate-y-0.5 focus-visible:border-[rgba(193,147,87,0.48)] focus-visible:shadow-[0_22px_42px_-28px_rgba(14,42,71,0.56)]",
                  "dark:border-[rgba(232,197,122,0.22)] dark:bg-[rgba(4,20,39,0.68)] dark:shadow-[0_18px_42px_-27px_rgba(0,0,0,0.94),inset_0_1px_0_rgba(255,255,255,0.04)]",
                  onRowClick && "cursor-pointer",
                )}
              >
                {primary ? (
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        "min-w-0 flex-1 text-[13px] font-black",
                        "text-navy",
                        "dark:text-ivory",
