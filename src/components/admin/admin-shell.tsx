...
const SCROLL_EDGE_TOP = cn(
  ...
  "bg-linear-to-b from-white/78 to-transparent",
  "dark:from-[#03111f]/90 dark:bg-linear-to-b dark:to-transparent",
);

const SCROLL_EDGE_BOTTOM = cn(
  "pointer-events-none absolute inset-x-0 bottom-0 z-3 h-4",
  "bg-linear-to-t from-white/78 to-transparent",
  "dark:from-[#03111f]/90 dark:bg-linear-to-t dark:to-transparent",
);
