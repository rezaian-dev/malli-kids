...
import {
  createProductAction,
  updateProductAction,
} from "@/app/admin/products/_lib/actions";
              ...
              <>
                <div className="space-y-2">
                  {values.variants.map((row, index) => (
                    <div
                      key={index}
                      className="grid grid-cols-2 items-end gap-2 sm:grid-cols-[1fr_1fr_5.5rem_auto]"
                    >
                      ...
                      <button
                        ...
                        className="bg-rose/10 text-rose hover:bg-rose/15 col-span-2 grid size-11 shrink-0 place-items-center justify-self-start rounded-xl transition sm:col-span-1"
                      >
