...
export function AdminHeaderIdentity({ profile }: { profile: AdminIdentity }) {
  ...
  return (
    <div
      className="flex h-10 min-w-0 items-center gap-2 rounded-xl border px-2.5 sm:px-3 border-navy/8 bg-white/62 shadow-[0_10px_24px_-22px_rgba(14,42,71,0.55)] dark:border-gold/15 dark:bg-white/4 dark:shadow-[0_12px_28px_-22px_rgba(0,0,0,0.85)]"
    ...
    >
      ...
      <span
        className="max-w-22 truncate text-[10px] font-black sm:max-w-40 sm:text-[11px] text-navy dark:text-ivory"
      >
        {profile.name}
      </span>
    </div>
