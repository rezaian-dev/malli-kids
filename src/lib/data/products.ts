...
const BASE: Omit<Product, "id">[] = [
  ...
  {
    img: "/brand/look-knit.jpg",
    name: "ست خانگی ابریِ پشمی",
    cat: "راحتی و خانگی",
    price: 890000,
    rate: 4.7,
    badge: "جدید",
    ...
    sold: 96,
    season: "زمستانه",
    desc: "بافت حوله‌ای نرم و گرم برای خانه؛ آزاد، سبک و ضدحساسیت برای بازی و استراحت.",
  },
  {
    img: "/brand/look-tryon.jpg",
    name: "ست راحتی لیننِ خانه",
    cat: "راحتی و خانگی",
    price: 760000,
    rate: 4.6,
    stock: true,
    sold: 74,
    season: "تابستانه",
    desc: "لینن تنفس‌پذیر با دوخت راحت؛ خنک برای روزهای گرم و سبک برای جنب‌وجوش خانه.",
  },
  {
    img: "/brand/hero-dress.jpg",
    name: "ست مجلسی و بیرونی ژلیان",
    cat: "بیرونی و مجلسی",
    price: 2350000,
    old: 2700000,
    disc: "۱۳٪",
    ...
    sold: 205,
    season: "بهاره",
    desc: "دامن تور چندلایه با کمربند ساتن؛ درخشش مجلسی با راحتیِ یک ست بیرونی.",
  },
  {
    img: "/brand/cat-boy.jpg",
    name: "کت بیرونی جشنِ پسرانه",
    cat: "بیرونی و مجلسی",
    price: 1980000,
    rate: 4.8,
    stock: true,
    sold: 143,
    season: "پاییزه",
    desc: "کت ساختارمند با آستر نرم؛ شیک برای مهمانی و بادوام برای گردش‌های بیرون.",
  },
  {
    img: "/brand/cat-baby.jpg",
