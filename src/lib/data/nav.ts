...
export const CAT_LINKS = [
  ...
  { href: "/shop?cat=راحتی و خانگی", label: "راحتی و خانگی", hint: "نرم و آزاد", icon: "sofa" },
  { href: "/shop?cat=بیرونی و مجلسی", label: "بیرونی و مجلسی", hint: "جشن و گردش", icon: "sparkles" },
